...
namespace Bai_36
{
    public partial class Form1 : Form
    {
        ...
        //btnThayDoiChuoiCon_Click
        private void button13_Click(object sender, EventArgs e)
        {
            txtKetQua.Text = txtDuLieuGoc.Text.
                Replace(txtChuoiConCu.Text, txtThayDoiChuoiConMoi.Text);
        ...
        private void btnTimViTriXuatHienDauTien_Click(object sender, EventArgs e)
        {
            ...
            if (vt != -1)
            {
                ...
                txtKetQua.Text = "Ko tìm thấy [" + txtChuoiTimViTriXuatHienDauTien.Text + "]";
        }

        private void btnTImViTriXuatHienCuoiCung_Click(object sender, EventArgs e)
        {
            int vt = txtDuLieuGoc.Text.LastIndexOf(txtChuoiTimViTriCuoiCung.Text);
            if (vt != -1)
            {
                txtKetQua.Text = "Tìm thấy [" +
                    txtChuoiTimViTriCuoiCung.Text + "] tại vị trí cuối cùng là " + vt;
            }
            else
                txtKetQua.Text = "Ko tìm thấy [" + txtChuoiTimViTriCuoiCung.Text + "]";
        }
        ...
        private void btnTachTu_Click(object sender, EventArgs e)
        {
            ...
            string[] arrWork = txtDuLieuGoc.Text.Split(arrKT);
            txtKetQua.Text = "";
            foreach (string s in arrWork)
                txtKetQua.Text += s + "\r\n";
        }
