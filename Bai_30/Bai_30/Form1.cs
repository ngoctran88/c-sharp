...
namespace Bai_30
{
    public partial class Form1 : Form
    {
        ...
        {
            //ta phải luôn luôn kiểm tra người sử dụng
            //có đang chọn dòng nào hay không
            ...
            */
            ...
            //=>Dùng cho ấn phím ctrl và click chuột chọn phần tử
            //ấn lstSo->selectionMode->MultiExtended
        ...
        {
            DialogResult ret = MessageBox.Show("Bạn muốn kết thúc chương trình không?", "Hỏi Kết Thúc", MessageBoxButtons.YesNo, MessageBoxIcon.Error);
